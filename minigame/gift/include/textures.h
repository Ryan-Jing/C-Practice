...
static const char *garden_lines[] = {
    "                    .---.                          ___________[]_____      ",
    "  @  *  @  *  @    /_\\ /_\\                      /    |    |         \\    ",
...
static const ascii_object garden = {
    .lines = garden_lines,
    .width = 75,
    .height = 6
};

static const char *swing_set_lines[] = {
    "                ",
    "  (o)-------o)  ",
    " / | \\      |\\ ",
    " | | |      | | ",
...
static const ascii_object swing_set = {
    .lines = swing_set_lines,
    .width = 16,
    .height = 5
};
